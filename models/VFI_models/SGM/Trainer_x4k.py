...
class Model:
    def __init__(self, local_rank):
        ...
        self.device()
        # BEGIN: load gmflow
        ckpt = torch.load(f'/data/fengxm/vimeo90k/pretrained_model/SGM/gmflow/gmflow_sintel-0c07dcb3.pth')
    ...
    def load_model(self, path=None, rank=0):
        def convert(param):
            return {
                k.replace("module.", ""): v
